...
const NavbarMobileEvento = () => {
  ...
  return (
    <nav className="w-auto px-0 h-12 fixed top-0 right-0 left-0 z-20 p-3 mt-0 bg-black md:invisible lg:h-0">
...
export default NavbarMobileEvento